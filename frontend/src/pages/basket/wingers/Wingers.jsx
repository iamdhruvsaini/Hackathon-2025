...
import { useGetWingersPlayersQuery } from "@/redux/features/position/playerPositionApi";
...
const Wingers = () => {
  ...
  const {
    ...
    isError,
    refetch,
  } = useGetWingersPlayersQuery({ page: pageCount, ...filters });
    ...
    <>
      <section className="bg-gray-50 xl:w-[1300px] mx-auto p-4 mt-10">
        <div className="mx-auto">
          <h1 className="scroll-m-20 text-2xl font-semibold tracking-tight pb-2 text-gray-700">
            Wingers
          </h1>
