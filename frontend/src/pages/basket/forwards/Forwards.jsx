...
const Forwards = () => {
  ...
  const { data: playerData, isLoading, isError } = useGetForwardsPlayersQuery({ page: pageCount, ...filters });
      ...
      <section className="bg-gray-50 xl:w-[1300px] mx-auto p-4 mt-10">
        <div className="mx-auto">
            ...
            <div className="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
                <h1 className='scroll-m-20 text-2xl font-semibold tracking-tight p-2 text-gray-700'>Forwards</h1>
                {/* table header */}
