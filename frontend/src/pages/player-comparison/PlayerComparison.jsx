      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
            Compare players based on their skills to enhance your team's performance.
          </p>
        </div>
        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            {selectedPlayers.map((player, index) => (
              <div
                key={index}
                className={`relative overflow-hidden rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl ${player.bought === 1 ? "bg-gradient-to-br from-red-50 to-red-100" : "bg-gradient-to-br from-white to-gray-50"
                  }`}
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-center space-x-6 mb-6 mt-4">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700 font-medium">{player.age} yrs</span>
                    </div>
                    <div className="flex items-center">
                      <Layers className="w-4 h-4 text-blue-600 mr-2" />
                      <span className="text-gray-700 font-medium">{player.club_position}</span>
                    </div>
                  </div>
            ...
            {selectedPlayers.length < 3 && (
              <div className="flex flex-col justify-center items-center rounded-xl bg-white shadow-md p-8 border min-h-[600px] border-gray-100 transition-all duration-300 hover:shadow-xl">
                <h3 className="text-xl font-bold text-gray-800 mb-3">Add Player</h3>
                ...
                >
                  ...
                  <UserRoundPlus className="w-24 h-24 text-blue-600 transition-all duration-300 group-hover:scale-110" />
                </button>
              </div>
            )}
          </div>
          ...
          {selectedPlayers.length === 0 && (
            <div className="text-center py-8">
              <p className="text-gray-500 italic">Select up to three players to compare their attributes</p>
            </div>
          )}
          ...
          {trigger && (
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-70 z-50 backdrop-blur-sm">
              <div className="bg-white rounded-xl shadow-2xl w-[90%] max-w-2xl p-6 animate-fadeIn">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-xl font-bold text-gray-800">Select a Player</h3>
                  <button
                    onClick={handleTrigger}
